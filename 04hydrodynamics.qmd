...
``` python
"""
Pipe Flow Rate Calculation for Oil
...
# Input parameters
internal_diameter_millimeters = 75.0  # Pipe internal diameter in mm
fluid_velocity_meters_per_second = 1.2  # Average velocity of oil in m/s
relative_density = 0.9  # Specific gravity of oil (relative to water)
density_water_kilograms_per_cubic_meter = 1000.0  # Density of water in kg/m³

# Unit conversion and geometry
internal_diameter_meters = internal_diameter_millimeters / 1000.0
pipe_radius_meters = internal_diameter_meters / 2.0

# Cross-sectional area of the pipe
cross_sectional_area_square_meters = math.pi * pipe_radius_meters ** 2

# Volumetric flow rate
volumetric_flow_rate_cubic_meters_per_second = (
    cross_sectional_area_square_meters * fluid_velocity_meters_per_second
)

# Density of the oil
oil_density_kilograms_per_cubic_meter = (
    relative_density * density_water_kilograms_per_cubic_meter
)

# Mass flow rate
mass_flow_rate_kilograms_per_second = (
    oil_density_kilograms_per_cubic_meter *
    volumetric_flow_rate_cubic_meters_per_second
)

# Convert mass flow rate to tonnes per hour
mass_flow_rate_tonnes_per_hour = (
    mass_flow_rate_kilograms_per_second * 3600 / 1000
)

# Display results
print("Pipe Flow Analysis Results:")
print(f"  Volumetric flow rate : "
      f"{volumetric_flow_rate_cubic_meters_per_second:.4f} m³/s")
print(f"  Mass flow rate       : "
      f"{mass_flow_rate_tonnes_per_hour:.4f} tonnes/hour")
```
:::

## Flow Through Valves

The area of escape is the annular area of the circumferential opening between the valve and seat, which is the circumference multiplied by the lift.
...
![Continuity equation](images/continuity.svg){#fig-continuity width="9.3cm"}
